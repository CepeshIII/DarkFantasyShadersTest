...
[VolumeComponentMenu("Post-processing Custom/AddOwnTextureToFrameData")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(AddOwnTextureToFrameDataRendererFeature))]
...
public sealed class AddOwnTextureToFrameDataVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public AddOwnTextureToFrameDataVolumeComponent()
    {
        displayName = "AddOwnTextureToFrameData";
    }
    ...
    public ClampedIntParameter _Radius = new ClampedIntParameter(1, 0, 10);
