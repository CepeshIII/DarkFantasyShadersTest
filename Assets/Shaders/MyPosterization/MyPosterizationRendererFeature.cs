...
internal class MyPosterizationRendererFeature : ScriptableRendererFeature
{
    [SerializeField] private MyPosterizationSettings settings;
    [SerializeField] private Shader shader;
    [SerializeField] private RenderPassEvent passEvent = RenderPassEvent.BeforeRenderingPostProcessing;


    private Material material;
    private MyPosterizationPass renderPass;
    ...
    public override void Create()
    {
        ...
        renderPass = new MyPosterizationPass(material, settings);
